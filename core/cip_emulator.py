...
class CIPEmulator:
    def __init__(self, app_config, consumer_config, producers_config, logger_server=None, logger_client=None, gui_mode=False):
        ...
        for client_tag, producer_config in producers_config.items():
            ...
            producer = CIPClient(producer_logger, producer_config, tag=client_tag)
